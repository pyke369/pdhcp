...
{
    {   DHCP_FRAME_RELAYHOPS,        { 0,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "bootp-relay-hops" },
    {   DHCP_FRAME_TRANSACTIONID,    { 0,   4,   4,   0 },  DHCP_OPTION_OPAQUE,                          "bootp-transaction-id" },
    {   DHCP_FRAME_STARTTIME,        { 0,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "bootp-start-time" },
    {   DHCP_FRAME_CLIENTADDRESS,    { 0,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "bootp-client-address" },
    {   DHCP_FRAME_ASSIGNEDADDRESS,  { 0,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "bootp-assigned-address" },
    {   DHCP_FRAME_SERVERADDRESS,    { 0,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "bootp-server-address" },
    {   DHCP_FRAME_RELAYADDRESS,     { 0,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "bootp-relay-address" },
    {   DHCP_FRAME_CLIENTHWADDRESS,  { 0,   6,   6,   0 },  DHCP_OPTION_OPAQUE,                          "client-hardware-address" },
    {   DHCP_FRAME_SERVERNAME,       { 0,   1,  63,   0 },  DHCP_OPTION_STRING,                          "bootp-server-name" },
    {   DHCP_FRAME_FILENAME,         { 0,   1, 127,   0 },  DHCP_OPTION_STRING,                          "bootp-filename" },
    {   0,                           { 0,   0,   0,   0 },  DHCP_OPTION_NONE,                            "pad" },
    {   1,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "subnet-mask" },
    {   2,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "time-offset" },
    {   3,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "routers" },
    {   4,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "time-servers" },
    {   5,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "name-servers" },
    {   6,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "domain-name-servers" },
    {   7,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "log-servers" },
    {   8,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "cookie-servers" },
    {   9,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "lpr-servers" },
    {  10,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "impress-servers" },
    {  11,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "resource-location-servers" },
    {  12,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "hostname" },
    {  13,                           { 1,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "boot-file-size" },
    {  14,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "merit-dump-file" },
    {  15,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "domain-name" },
    {  16,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "swap-server" },
    {  17,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "root-path" },
    {  18,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "extensions-path" },
    {  19,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "ip-forwarding" },
    {  20,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "non-local-source-routing" },
    {  21,                           { 1,   8,   0,   8 },  DHCP_OPTION_ADDRESSMASK | DHCP_OPTION_LIST,  "policy-filters" },
    {  22,                           { 1,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "maximum-datagram-reassembly-size" },
    {  23,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "ip-default-ttl" },
    {  24,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "path-mtu-aging-timeout" },
    {  25,                           { 1,   2,   0,   2 },  DHCP_OPTION_INTEGER | DHCP_OPTION_LIST,      "path-mtu-plateau-table" },
    {  26,                           { 1,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "interface-mtu" },
    {  27,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "all-subnets-local" },
    {  28,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "broadcast-address" },
    {  29,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "perform-mask-discovery" },
    {  30,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "mask-supplier" },
    {  31,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "perform-router-discovery" },
    {  32,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "router-solicitation-address" },
    {  33,                           { 1,   8,   0,   8 },  DHCP_OPTION_ADDRESSMASK | DHCP_OPTION_LIST,  "static-routes" },
    {  34,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "trailer-encapsulation" },
    {  35,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "arp-cache-timeout" },
    {  36,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "ethernet-encapsulation" },
    {  37,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "tcp-default-ttl" },
    {  38,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "tcp-keepalive-interval" },
    {  39,                           { 1,   1,   1,   0 },  DHCP_OPTION_BOOLEAN,                         "tcp-keepalive-garbage" },
    {  40,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "nis-domain" },
    {  41,                           { 1,   4,   4,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "nis-servers" },
    {  42,                           { 1,   4,   4,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "ntp-servers" },
    {  43,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "vendor-specific-information" },
    {  44,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "netbios-name-servers" },
    {  45,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "netbios-dgram-distribution-servers" },
    {  46,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "netbios-node-type" },
    {  47,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "netbios-scope" },
    {  48,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "xwindow-font-servers" },
    {  49,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "xwindow-display-managers" },
    {  50,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "requested-ip-address" },
    {  51,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "address-lease-time" },
    {  52,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "option-overload" },
    {  53,                           { 1,   1,   1,   0 },  DHCP_OPTION_TYPE,                            "dhcp-message-type" },
    {  54,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "server-identifier" },
    {  55,                           { 1,   1,   0,   1 },  DHCP_OPTION_OPTION | DHCP_OPTION_LIST,       "parameters-request-list" },
    {  56,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "message" },
    {  57,                           { 1,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "max-message-size" },
    {  58,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "renewal-time" },
    {  59,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "rebinding-time" },
    {  60,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "vendor-class-identifier" },
    {  61,                           { 1,   2,   0,   0 },  DHCP_OPTION_OPAQUE,                          "client-identifier" },
    {  62,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "netware-domain" },
    {  63,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "netware-option" },
    {  64,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "nisp-domain" },
    {  65,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "nisp-servers" },
    {  66,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "tftp-server" },
    {  67,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "boot-filename" },
    {  68,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "mobile-ip-home-agents" },
    {  69,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "smtp-servers" },
    {  70,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "pop3-servers" },
    {  71,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "nntp-servers" },
    {  72,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "www-servers" },
    {  73,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "finger-servers" },
    {  74,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "irc-servers" },
    {  75,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "streettalk-servers" },
    {  76,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "streettalk-directory-servers" },
    {  77,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "user-class" },
    {  78,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "directory-agent" },
    {  79,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "service-scope" },
    {  81,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "client-fqdn" },
    {  82,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "relay-agent-information" },
    {  83,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "isns-configuration" },
    {  85,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "nds-servers" },
    {  86,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "nds-tree-name" },
    {  87,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "nds-context" },
    {  88,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "bcmcs-domain" },
    {  89,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "bcmcs-servers" },
    {  90,                           { 1,   3,   0,   0 },  DHCP_OPTION_OPAQUE,                          "authentication" },
    {  91,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "last-transaction-time" },
    {  92,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "associated-addresses" },
    {  93,                           { 1,   2,   2,   0 },  DHCP_OPTION_INTEGER,                         "client-system" },
    {  94,                           { 1,   3,   3,   0 },  DHCP_OPTION_OPAQUE,                          "cliend-ndi" },
    {  97,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "client-guid" },
    {  98,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "user-authentication" },
    {  99,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "geoconf-civic" },
    { 100,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "tz-posix" },
    { 101,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "tz-database" },
    { 116,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "auto-configuration" },
    { 117,                           { 1,   2,   0,   2 },  DHCP_OPTION_INTEGER | DHCP_OPTION_LIST,      "name-service-search" },
    { 118,                           { 1,   4,   4,   0 },  DHCP_OPTION_ADDRESS,                         "subnet-selection" },
    { 119,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "domain-search" },
    { 120,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "sip-server" },
    { 121,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "classless-route" },
    { 122,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "cablelabs-configuration" },
    { 123,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "geoconf" },
    { 124,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "vi-vendor-class" },
    { 125,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "vi-vendor-specific-information" },
    { 136,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "pana-agents" },
    { 137,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "v4-lost" },
    { 138,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-capwap-access-controller" },
    { 139,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-address-mos" },
    { 140,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-fqdn-mos" },
    { 141,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "sip-ua-domain" },
    { 142,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-address-andsf" },
    { 144,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-geoloc" },
    { 145,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "forcerenew-nonce-capable" },
    { 146,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "rdnss-selection" },
    { 150,                           { 1,   4,   0,   4 },  DHCP_OPTION_ADDRESS | DHCP_OPTION_LIST,      "tftp-servers" },
    { 151,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "status-code" },
    { 152,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "base-time" },
    { 153,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "start-time-of-state" },
    { 154,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "query-start-time" },
    { 155,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "query-end-time" },
    { 156,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "dhcp-state" },
    { 157,                           { 1,   1,   1,   0 },  DHCP_OPTION_INTEGER,                         "data-source" },
    { 158,                           { 1,   5,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v4-pcp-server" },
    { 208,                           { 1,   4,   4,   0 },  DHCP_OPTION_OPAQUE,                          "pxelinux-magic" },
    { 209,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "configuration-file" },
    { 210,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "path-prefix" },
    { 211,                           { 1,   4,   4,   0 },  DHCP_OPTION_INTEGER,                         "reboot-time" },
    { 212,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "v6-6rd" },
    { 213,                           { 1,   1,   0,   0 },  DHCP_OPTION_STRING,                          "v4-access-domain" },
    { 220,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "subnet-allocation" },
    { 221,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "virtual-subnet-allocation" },
    { 224,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-01" },
    { 225,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-02" },
    { 226,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-03" },
    { 227,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-04" },
    { 228,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-05" },
    { 229,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-06" },
    { 230,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-07" },
    { 231,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-08" },
    { 232,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-09" },
    { 233,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-10" },
    { 234,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-11" },
    { 235,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-12" },
    { 236,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-13" },
    { 237,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-14" },
    { 238,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-15" },
    { 239,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-16" },
    { 240,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-17" },
    { 241,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-18" },
    { 242,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-19" },
    { 243,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-20" },
    { 244,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-21" },
    { 245,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-22" },
    { 246,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-23" },
    { 247,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-24" },
    { 248,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-25" },
    { 249,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-26" },
    { 250,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-27" },
    { 251,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-28" },
    { 252,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-29" },
    { 253,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-30" },
    { 254,                           { 1,   1,   0,   0 },  DHCP_OPTION_OPAQUE,                          "private-31" },
    { 255,                           { 0,   0,   0,   0 },  DHCP_OPTION_NONE,                            "end" },
};
...
bool dhcp_encode(char *input, DHCP_FRAME *frame, ssize_t *frame_size, char *error, size_t error_size)
{
    DHCP_OPTION    *option;
    struct in_addr address;
    uint32_t       index, lindex, nkey, nvalue[ETH_ALEN], items;
